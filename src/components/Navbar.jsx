...
export default function Navbar() {
    return (
        <>
            <div>
                <nav className=" py-[1.12rem] px-4 flex items-center justify-between bg-[#161D2F] md:mx-[1.58rem] md:my-[1.44rem] md:rounded-xl fixed top-0 left-0 right-0 z-50 xl:w-24 xl:h-[50rem] xl:flex-col">
                    <div>
                        <img src="/images/Logo.svg" alt="logo" />
                    </div>

                    <ul className=" flex items-center gap-6 xl:flex-col">
                        <li>
                            <NavLink
                                to="/"
                                className={({ isActive }) =>
